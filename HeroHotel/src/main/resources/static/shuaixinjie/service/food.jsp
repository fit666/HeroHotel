...
<body>
	<div class="place">
		<span>位置：</span>
		<ul class="placeul">
			<li><a href="index.html" target="rightFrame">食品管理</a></li>
			<li><a href="#">食品列表</a></li>
		</ul>
	</div>
	<div class="rightinfo">
		<div class="tools">
			<div class="itab">
				<ul>
					<li><a href="#tab1" class="selected">食品图片列表</a></li>
					<li><button class='layui-btn layui-btn-xs' onclick="show()">新增食品</button></li>
				</ul>
			</div>
